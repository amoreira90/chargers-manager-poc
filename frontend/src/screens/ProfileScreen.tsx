    ...
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.avatarContainer}>
          <View style={[styles.avatar, { backgroundColor: isDark ? '#2A3A50' : '#f0f0f0' }]}>
        ...
        {/* Stats */}
        <View style={[styles.card, { backgroundColor: colors.card, shadowColor: colors.shadow }]}>
          <Text style={[styles.cardTitle, { color: colors.text }]}>Estadísticas</Text>
          <View style={styles.statsGrid}>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="lightning-bolt" size={28} color={colors.warning} />
              <Text style={[styles.statValue, { color: colors.text }]}>125.5</Text>
              <Text style={[styles.statLabel, { color: colors.textTertiary }]}>kWh Cargados</Text>
            </View>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="cash" size={28} color={colors.success} />
              <Text style={[styles.statValue, { color: colors.text }]}>$312</Text>
              <Text style={[styles.statLabel, { color: colors.textTertiary }]}>Gastados</Text>
            </View>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="counter" size={28} color={colors.primary} />
              <Text style={[styles.statValue, { color: colors.text }]}>8</Text>
              <Text style={[styles.statLabel, { color: colors.textTertiary }]}>Cargas</Text>
            </View>
          </View>
        </View>
            ...
            {themeOptions.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      mode === option.key ? (isDark ? '#1A3A5C' : '#E3F2FD') : colors.inputBg,
              ...
              >
                <MaterialCommunityIcons
                  ...
                  size={24}
                  color={mode === option.key ? colors.primary : colors.textTertiary}
                />
                <Text
                  style={[
        ...
        {/* Settings */}
        <View style={[styles.card, { backgroundColor: colors.card, shadowColor: colors.shadow }]}>
          <Text style={[styles.cardTitle, { color: colors.text }]}>Preferencias</Text>

          <TouchableOpacity style={[styles.settingRow, { borderBottomColor: colors.borderLight }]}>
            <View style={styles.settingLeft}>
              <MaterialCommunityIcons name="bell" size={20} color={colors.primary} />
              <Text style={[styles.settingTitle, { color: colors.text }]}>Notificaciones</Text>
            </View>
          ...
          <TouchableOpacity style={[styles.settingRow, { borderBottomColor: colors.borderLight }]}>
            <View style={styles.settingLeft}>
              ...
              <Text style={[styles.settingTitle, { color: colors.text }]}>Seguridad</Text>
            </View>
            <MaterialCommunityIcons name="chevron-right" size={20} color={colors.textTertiary} />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={[styles.settingRow, { borderBottomColor: colors.borderLight }]}>
            <View style={styles.settingLeft}>
              ...
              <Text style={[styles.settingTitle, { color: colors.text }]}>Ayuda</Text>
            </View>
            <MaterialCommunityIcons name="chevron-right" size={20} color={colors.textTertiary} />
          </TouchableOpacity>
        </View>
