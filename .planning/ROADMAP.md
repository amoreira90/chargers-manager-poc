...
**Depende de**: Fase 0
**Requisitos**: INF-01, INF-02, AUTH-01, AUTH-02, AUTH-03, AUTH-04, AUTH-05, AUTH-06, AUTH-07, AUTH-08, CHRG-01, CHRG-02, CHRG-03, CHRG-04, CHRG-05
**Criterios de éxito** (qué debe ser VERDAD):
  ...
  2. El usuario puede autenticarse con Google o Apple OAuth y recuperar una contraseña olvidada mediante enlace de email
  3. Una cuenta de usuario puede tener múltiples roles simultáneamente (ej: conductor y propietario) y el sistema aplica controles de acceso basados en roles
...
**Depende de**: Fase 1
**Requisitos**: OCPP-01, OCPP-02, OCPP-03, OCPP-04, OCPP-05, OCPP-06, OCPP-07, OCPP-08, OCPP-09, OCPP-10, CHRG-06, CHRG-07, INF-03, INF-04
**Criterios de éxito** (qué debe ser VERDAD):
...
**Depende de**: Fase 2
**Requisitos**: SESS-01, SESS-02, SESS-03, SESS-04, SESS-05, SESS-06, SESS-07, PRICE-01, PRICE-02, PRICE-03, PRICE-04, PRICE-05, PRICE-06
**Criterios de éxito** (qué debe ser VERDAD):
...
**Depende de**: Fase 3
**Requisitos**: PAY-01, PAY-02, PAY-03, PAY-04, PAY-05, PAY-06, PAY-07, PAY-08
**Criterios de éxito** (qué debe ser VERDAD):
...
**Criterios de éxito** (qué debe ser VERDAD):
  ...
  4. El login al panel admin requiere 2FA (TOTP); las operaciones sobre cuentas admin son auditadas
